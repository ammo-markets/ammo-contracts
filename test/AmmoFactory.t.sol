...
contract AmmoFactoryTest is Test {
    ...
    function testCreateCaliber() public {
        (address market, address token) = factory.createCaliber(CALIBER_9MM, "Ammo 9MM", "MO9MM", 50);
    ...
    function testCreateMultipleCalibers() public {
        factory.createCaliber(CALIBER_9MM, "Ammo 9MM", "MO9MM", 50);
        factory.createCaliber(CALIBER_556, "Ammo 5.56", "MO556", 25);
    ...
    function testCannotCreateDuplicateCaliber() public {
        ...
        factory.createCaliber(CALIBER_9MM, "Ammo 9MM v2", "MO9V2", 50);
    }
